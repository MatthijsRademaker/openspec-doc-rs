...
Only a comment is editable, never a reply: a reply is part of the conversation's append-only record, and rewriting it would remove words one participant already contributed.
