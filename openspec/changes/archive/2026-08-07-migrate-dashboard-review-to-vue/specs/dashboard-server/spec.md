...
#### Scenario: A dashboard reply retains reviewer identity

- **WHEN** a reply is submitted through a scope's JSON endpoint
- **THEN** the system SHALL record and return that reply as reviewer-authored
