...
There is one copy of that file, in the binary. Every project's copy is its output, including this one, so a divergence appears as a diff rather than as a defect in a project nobody is looking at.
