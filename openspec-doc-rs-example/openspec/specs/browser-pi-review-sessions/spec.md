...
Provide browser-native Pi review sessions for active OpenSpec change feedback and artifacts while keeping browser-triggered analysis local, active-change-only, and non-mutating.
