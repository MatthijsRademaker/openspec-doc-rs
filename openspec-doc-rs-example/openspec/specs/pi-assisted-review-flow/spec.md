...
Provide a Pi-invokable workflow that helps users review active OpenSpec changes in the browser viewer without mutating OpenSpec artifacts when starting review.
