...
- **Motion is instrument-grade.** Acquire exact coordinates, triangulate linked content, transmit
  reviewer intent, receive real arrivals, resolve semantic geometry, and reconfigure chassis. Use
  central 100–200ms timing, hard masks, registration rules, optical slits, and glyph/line
  metamorphosis only for real events. Same-channel events replace older marks; document receipt and
  reviewer confirmation stay independent. Reduced motion skips native view transitions and makes
  displacement, clipping, masks, and smooth scroll immediate. No perpetual artwork, parallax,
  pointer-following fields, cursor trails, sound, spring spectacle, whole-page glitch, or decorative
  loaders.
